...
@section('main-content')
    ...
    <div class="row">
        <div class="col mb-4">
            <div class="dropdown float-right">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="top-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, -118px, 0px);">
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered" id="premise-table">
                        <thead>
                        <tr>
                            <th scope="col">#</th>
